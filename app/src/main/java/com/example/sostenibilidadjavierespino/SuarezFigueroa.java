...
import android.view.LayoutInflater; // <-- NUEVO IMPORT NECESARIO
...
public class SuarezFigueroa extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_suarez_figueroa);
        ...
        buttonInvernadero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SuarezFigueroa.this, InvernaderoSuarez.class);
        ...
        buttonEstacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SuarezFigueroa.this, EstacionSuarez.class);
                startActivity(intent);
            }
        });
        ...
        navAtras.setOnItemSelectedListener(new BottomNavigationView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.item_volver) {
                    ...
                    new AlertDialog.Builder(SuarezFigueroa.this)
    ...
    private void mostrarDialogoCentroInfo() {
        ...
        View dialogView = inflater.inflate(R.layout.info_suarez_figueroa, null);
